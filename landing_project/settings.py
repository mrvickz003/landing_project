...
SECRET_KEY = 'django-insecure-)g6%k7ij$$5yu*ncs2r5es3h5ni)=6n4xgb_ed)kb=a#1=@hdq'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'landing_project/templates')], 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticated',  # Enforce authentication for APIs
    ),
}
